...
ArgEnd:';' INTEGER VARIABLE ArgsInt ArgEnd		{$$=TreeCreate(Integer,0,$3,NULL,$4,$5,NULL,Argument);};

	| 	';'  BOOLEAN VARIABLE ArgsBool ArgEnd	{$$=TreeCreate(Boolean,0,$3,NULL,$4,$5,NULL,Argument);};
